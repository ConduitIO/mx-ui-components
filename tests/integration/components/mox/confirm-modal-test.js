...
module('Integration | Component | mox/confirm-modal', function (hooks) {
  ...
  module('styling: dark mode', function (hooks) {
    ...
    module('when confirming', function (hooks) {
      ...
      test('it displays the default submit button (dark mode)', async function (assert) {
        assert
          .dom('[data-test-confirm-submit-button]')
          .hasClass('dark:border-red-800');
      });
    ...
    module('when text confirming', function (hooks) {
      ...
      test('it displays the danger submit button (dark mode)', async function (assert) {
        assert
          .dom('[data-test-confirm-submit-button]')
          .hasClass('dark:border-red-800');
      });
